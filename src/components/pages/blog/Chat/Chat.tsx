...
const Chat = (): ReactElement => {
  ...
  return (
    <div className={styles.chat}>
      <Window type={EWindowType.CHAT} title=''>
        <div className={styles.chat__header}>
          <FontAwesomeIcon icon={faAngleLeft} />
          <div className={styles.chat__title}>Buddy</div>
          <FontAwesomeIcon icon={faPhone} />
        </div>
        <div className={styles.chat__wrapper}>
          <div className={styles.chat__date}>{currentDate}</div>
          <div className={bind([styles.chat__row, styles.left])}>
            <div className={bind([styles.chat__message, styles.left])}>What do you like doing?</div>
          </div>
          <div className={bind([styles.chat__row, styles.right])}>
            <div className={bind([styles.chat__message, styles.right])}>I like eating cakes</div>
          </div>
          <div className={bind([styles.chat__row, styles.right])}>
            <div className={bind([styles.chat__message, styles.emoji])}>😎</div>
          </div>
          <div className={bind([styles.chat__row, styles.right, styles.note])}>
            <div className={styles.chat__note}>Seen</div>
          </div>
          <div className={bind([styles.chat__row, styles.left])}>
            <div className={bind([styles.chat__message, styles.emoji])}>🍰 🍰 🍰</div>
          </div>
          <div className={styles.chat__footer}>Typing...</div>
        </div>
