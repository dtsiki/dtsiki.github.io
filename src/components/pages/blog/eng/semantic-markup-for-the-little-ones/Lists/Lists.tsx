...
export const Lists = () => {
  ...
  const exampleHTMLUl = `<h3>Ingredients</h3>
<ul>
  <li>Milk</li>
  <li>Sugar</li>
  ...
  const exampleHTMLOl = `<h3>Tips for making the best cinnamon rolls</h3>
<ol>
  ...
  const exampleHTMLDl = `<h3>Ingredients</h3>
<dl>
  <dt>Milk</dt>
  ...
  const exampleHTMLNested = `<h3>Ingredients</h3>
<ul>
  <li>
    For the dough
    <ul>
  ...
  return (
    <>
      ...
      <div className='flex h-centered'>
        <div className='row'>
          <div className='col col--50 col--tablet-100'>
            <p>
              Lists are very useful way to organize content. They help perceive and understand an information in web
              pages.
            </p>
            <p className='spacer bottom medium'>
              Of course, HTML supports lists. Seems like there are not a lot of lists in web pages, but actually there
              are. For example, any navigation is logically list of links. Take a look below at the navigation I&#39;ve
              been using myself:
            </p>
            <Window type={EWindowType.CUSTOM}>
              <div className={styles.lists__demo}>
                <nav className={styles.lists__menu}>
          ...
          <div className='col col--50 col--tablet-100'>
            <div className='spacer top small'>
              <CodeSnippet lang={ECodeLang.HTML} name='index' code={exampleHTMLNavList} />
            </div>
          </div>
        </div>
      </div>
      <p className='spacer top large'>
        There are two types of lists in HTML: mentioned above <HtmlTag isSingle>ul</HtmlTag> element is for unordered
        lists and <HtmlTag isSingle>ol</HtmlTag> for ordered. The first is typically rendered as a bulleted list, the
        second one is typically rendered as a numbered list. HTML element <HtmlTag isSingle>li</HtmlTag> is used to
        represent an item in all types of lists. The browser&#39;s default styling dictates that unordered lists{' '}
        <HtmlTag isSingle>ul</HtmlTag> have bullets and ordered lists <HtmlTag isSingle>ol</HtmlTag> have numbers.
        However, using CSS properties like <code className='highlighted ghost'>list-style-type</code> you may change
        this default styles.
      </p>
      <div className='flex h-centered'>
        <div className='row'>
          <div className='col col--50 col--tablet-100'>
            <CodeSnippet lang={ECodeLang.HTML} name='index' code={exampleHTMLUl} />
            <div className='spacer top medium'>
              <Window type={EWindowType.CUSTOM}>
                <div className={styles.lists__demo}>
                  <h3 className={bind([styles.lists__subtitle, 'spacer bottom small'])}>Ingredients</h3>
          ...
          <div className='col col--50 col--tablet-100'>
            <CodeSnippet lang={ECodeLang.HTML} name='index' code={exampleHTMLOl} />
            <div className='spacer top medium'>
              <Window type={EWindowType.CUSTOM}>
                <div className={styles.lists__demo}>
                  <h3 className={bind([styles.lists__subtitle, 'spacer bottom small'])}>
      ...
      <p className='spacer top large'>
        But in fact, there is third type of HTML lists: <HtmlTag isSingle>dl</HtmlTag>. What does it mean? This element
        encloses a list of groups of terms specified using the <HtmlTag isSingle>dt</HtmlTag> element and descriptions
        provided by <HtmlTag isSingle>dd</HtmlTag> elements. The main reason for description lists is to preserve
        semantic connection for term-value pairs which would get lost if we just used unordered or ordered lists.
        Description lists also have default browser&#39;s style, check it out in the example below.
      </p>
      <div className='flex h-centered'>
        <div className='row'>
          <div className='col col--50 col--tablet-100'>
            <CodeSnippet lang={ECodeLang.HTML} name='index' code={exampleHTMLDl} />
          </div>
          <div className='col col--50 col--tablet-100'>
            <Window type={EWindowType.CUSTOM}>
              <div className={styles.lists__demo}>
      ...
      <p className='spacer top large'>
        Let&#39;s be honest, descriptions are not the most popular kind of HTML lists, but feel free to use it because
        there are not any restrictions for its usage.
      </p>
      <p>
        And not to forget about one of the most important feature of using lists: every list can be nested into another.
        Lists may be nested as deeply as desired. Nesting lists allow us to structurize web pages content and create
        nested dropdown navigations.
      </p>
      <div className='flex h-centered'>
        <div className='row'>
          <div className='col col--50 col--tablet-100'>
            <CodeSnippet lang={ECodeLang.HTML} name='index' code={exampleHTMLNested} />
          </div>
          <div className='col col--50 col--tablet-100'>
            <Window type={EWindowType.CUSTOM}>
              <div className={styles.lists__demo}>
